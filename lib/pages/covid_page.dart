...
import 'package:covid_data_show/Bloc/covid_bloc.dart';
import 'package:covid_data_show/Bloc/covid_event.dart';
import 'package:covid_data_show/Bloc/covid_state.dart';
...
class _CovidPageState extends State<CovidPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('COVID-19 Data Show'),centerTitle: true,),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const SizedBox(height: 10),
              Text("Date: ${model.countries![index].date}"),
            ],
          ),
        );
      },
